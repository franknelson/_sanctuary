<?php
/**
 * _sanctuary functions and definitions
 *
 * @package _sanctuary
 */
...
if ( ! function_exists( '_sanctuary_setup' ) ) :
/**
 ...
 */
function _sanctuary_setup() {

	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on _sanctuary, use a find and replace
	 * to change '_sanctuary' to the name of your theme in all the template files
	 */
	load_theme_textdomain( '_sanctuary', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Menu', '_sanctuary' ),
        'social' => __( 'Social Menu', '_sanctuary' ),
	) );
 ...
 */
function _sanctuary_widgets_init() {
	register_sidebar( array(
		'name'          => __( 'Sidebar', '_sanctuary' ),
		'id'            => 'sidebar-1',
		'description'   => '',
...
add_action( 'widgets_init', '_sanctuary_widgets_init' );
...
add_action( 'wp_enqueue_scripts', '_sanctuary_scripts' );
